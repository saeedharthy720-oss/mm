-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('card', 'pay_on_delivery');
...
CREATE TABLE "products" (
    ...
    "manual_stock_override" BOOLEAN NOT NULL DEFAULT false,
    "delivery_charge" DECIMAL(10,3) NOT NULL DEFAULT 0,
    "is_active" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "orders" (
    ...
    "delivery_charge_total" DECIMAL(10,3) NOT NULL,
...
CREATE TABLE "order_items" (
    ...
    "delivery_charge_snapshot" DECIMAL(10,3) NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE UNIQUE INDEX "order_statuses_key_key" ON "order_statuses"("key");
